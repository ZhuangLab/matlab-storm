...
dlg_title = 'Step 6 Pars: Quantify Features';  num_lines = 1;
   Dprompt = {
    ...
    if notCancel
    CC{handles.gui_number}.pars6.boxSize = str2num(Opts{1}); %#ok<*ST2NM> % 30
    CC{handles.gui_number}.pars6.startFrame= str2num(Opts{2});  %  1;
	CC{handles.gui_number}.pars6.minLoc= str2num(Opts{3});  % 0;
	CC{handles.gui_number}.pars6.minSize= str2num(Opts{4});  % 30; 
